function  [rez]=projection_2(rez,DATA)
...
for i=1:M_clust
    PC = rez.distPC{i}; 
                    ...
                    [~, pv] = HartigansDipSignifTest(sort(PC), length(PC));
