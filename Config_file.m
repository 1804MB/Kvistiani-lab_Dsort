...
ops.Nfilt               = 8;           % number of clusters to use 
...
ops.criteria_NCC         = 0.85;          % criteria to detect spikes from the normalized cross correlation [number between -1 and 1]	
...
ops.p_val_dip_test  = 0.99;     %Threshold criteria for Hartigan dip test p-value 
